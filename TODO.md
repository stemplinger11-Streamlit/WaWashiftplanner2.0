...
Stand: 02.09.2026 · Basis: `streamlit_app.py` V8.1 (3.362 Zeilen, Monolith)
...
1. **Sommerpause:** Startet die Saison im September oder im Oktober? (bestimmt Priorität von Punkt 1)
2. **Stornofrist:** Soll die im Handbuch genannte 24h-Frist wirklich gelten?
3. **Registrierung:** Offen für jeden oder mit Admin-Freigabe?
4. **Erinnerungen:** Sind sie gewünscht? Dann braucht es einen externen Cron-Trigger, da Streamlit.io das nicht leisten kann.
5. Weitere gewünschte Features (wurden für später angekündigt).
